...
const Review = () => {
  return (
    <div className="review flex flex-col gap-5 md:gap-0 lg:h-[755px] bg-[#e6f1dd] lg:flex-row items-center md:mb-0 overflow-hidden py-0">
      {/* <div className="image"></div> */}
      <div className="h-[100%] w-fit video-overlay">
        <video autoPlay muted loop className="">
          <source src="/bannerVideo2.mp4" />
        </video>
      </div>
